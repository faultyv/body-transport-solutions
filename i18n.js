(() => {
  ...
  const rows = [
    ...
    ['Controlled refrigeration, set for the transfer.','Beheerde verkoeling, ingestel vir die vervoer.','Isiqandisi esilawulwayo, esisethwe ngokohambo.'],
    ['Controller display during cooling','Beheerdervertoning tydens verkoeling','Isibonisi sesilawuli ngesikhathi sokupholisa'],
    ...
    ["The controller demonstrates the refrigeration system's reserve cooling capacity. For transport, the compartment is set and monitored at the controlled cold condition required for the transfer.",'Die beheerder demonstreer die verkoelingstelsel se reserwe-verkoelingskapasiteit. Vir vervoer word die kompartement ingestel en gemonitor vir die beheerde koue toestand wat vir die vervoer vereis word.','Isilawuli sibonisa amandla okupholisa agciniwe ohlelo lwesiqandisi. Ngesikhathi sokuthutha, igumbi lisethwa futhi liqashwe esimweni esibandayo esilawulwayo esidingekayo kulolo hambo.'],
    ['Refrigeration controller display during cooling','Verkoelingsbeheerder se vertoning tydens verkoeling','Isibonisi sesilawuli sesiqandisi ngesikhathi sokupholisa'],
    ...
    ['The compartment is pre-cooled and held under controlled refrigeration, set for the transfer.','Die kompartement word vooraf verkoel en onder beheerde verkoeling gehou, ingestel vir die vervoer.','Igumbi lipholiswa kusengaphambili futhi ligcinwe ngaphansi kwesiqandisi esilawulwayo, ngokohambo.'],
    ...
    ['Controlled refrigeration, set for each transfer','Beheerde kouebeheer, ingestel vir elke vervoer','Ukulawula amakhaza okulawulwayo, kusethwe ngohambo ngalunye'],
    ['The compartment can be pre-cooled and maintained under controlled refrigeration according to the transfer requirements.','Die kompartement kan vooraf verkoel en onder beheerde verkoeling gehou word volgens die vervoervereistes.','Igumbi lingapholiswa kusengaphambili futhi ligcinwe ngaphansi kwesiqandisi esilawulwayo, ngokwezidingo zohambo.'],
    ...
    ['Controlled refrigeration','Beheerde verkoeling','Isiqandisi esilawulwayo'],
    ...
    ['Explore','Verken','Hlola'],
    ['Company & contact','Maatskappy en kontak','Inkampani nokuxhumana'],
    ['Dispatch enquiries 24/7','Versendingsnavrae 24/7','Imibuzo yokuthumela 24/7'],
    ['Cato Ridge / Camperdown · N3 corridor','Cato Ridge / Camperdown · N3-korridor','Cato Ridge / Camperdown · umhubhe we-N3'],
    ['KwaZulu-Natal daily · longer routes by arrangement','KwaZulu-Natal daagliks · langer roetes volgens reëling','KwaZulu-Natal nsuku zonke · imizila emide ngokuhlelwa'],
    ['Services, coverage & resources','Dienste, dekking en hulpbronne','Izinsizakalo, ukufinyelela nezinsiza'],
    ['Knowledge hub','Kennisentrum','Isikhungo solwazi'],
    ['Procurement guidance','Aankoopriglyne','Isiqondiso sokuthengwa kwezinsizakalo'],
    ['Healthcare workflows','Gesondheidsorg-werkvloeie','Ukuhamba komsebenzi wezempilo'],
    ['KZN area network','KZN-gebiedsnetwerk','Inethiwekhi yezindawo zaseKZN'],
    ...
    ['Refrigerated transport for the deceased.','Verkoelde vervoer van afgestorwenes.','Ukuthuthwa kwabashonile ngesiqandisi.'],
    ['Across KwaZulu-Natal.','Regdeur KwaZulu-Natal.','Kulo lonke elaseKwaZulu-Natal.'],
    ['Need the deceased collected from a hospital or moved to a mortuary?','Moet die afgestorwene by ’n hospitaal afgehaal of na ’n lykshuis vervoer word?','Udinga ukuthi oshonile alandwe esibhedlela noma ayiswe emakhazeni?'],
    ['We provide direct refrigerated transport for funeral parlours, hospitals, mortuaries, insurers and authorised repatriation coordinators.','Ons verskaf direkte verkoelde vervoer vir begrafnisondernemings, hospitale, lykshuise, versekeraars en gemagtigde repatriasiekoördineerders.','Sinikeza ukuthuthwa okuqondile ngesiqandisi kwamakhaya abangcwabi, izibhedlela, amakhaza, abomshwalense nabaxhumanisi abagunyaziwe bokubuyisela ekhaya.'],
    ...
    ['Simple, direct collection and transfer','Eenvoudige, direkte afhaal en vervoer','Ukulanda nokuthutha okuqondile, okulula'],
    ['Hospital-to-mortuary transport','Vervoer van hospitaal na lykshuis','Ukuthutha kusuka esibhedlela kuya emakhazeni'],
    ['Deceased removal and transfer','Verwydering en vervoer van afgestorwenes','Ukulanda nokuthutha oshonile'],
    ...
    ['The stainless-steel compartment combines forced-air cooling, an easy-clean transport platform and a dedicated condensate drainage line. The compartment is pre-cooled and set to the controlled cold condition required for each transfer.','Die vlekvryestaalkompartement kombineer gedwonge-lugverkoeling, ’n maklik-skoonmaakbare vervoerplatform en ’n toegewyde kondensaatdreineringslyn. Die kompartement word vooraf verkoel en ingestel op die beheerde koue toestand wat vir elke vervoer vereis word.','Igumbi lensimbi engagqwali lihlanganisa ukupholisa ngomoya ophoqiwe, isiteji sokuthutha esihlanzeka kalula kanye nepayipi elizinikele lokukhipha amanzi. Igumbi lipholiswa kusengaphambili futhi lisethwe esimweni esibandayo esilawulwayo esidingekayo ngohambo ngalunye.'],
