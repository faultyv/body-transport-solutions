(function (window, document) {
  ...
  function ensureConsentBanner() {
    ...
    banner.innerHTML = '<div class="bts-seo-consent__copy"><strong>Can we count your visit?</strong><span>We use privacy-friendly analytics to improve the site. Nothing personal is sold or shared. <a href="/privacy.html">How we use cookies</a></span></div><div class="bts-seo-consent__actions"><button type="button" data-bts-consent-choice="declined">No thanks</button><button type="button" data-bts-consent-choice="accepted">Yes, allow</button></div>';
